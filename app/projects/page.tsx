...
const PROJECTS: Project[] = [
  {
    ...
    description:
      "The Kenneth Dike Library website is a clean, modern web platform designed to provide easy access to library information and resources and visitors to explore library services, resources.",
  ...
  },
  {
    ...
    description:
      "A Christian church and online ministry platform, with a dashboard that allows user to update and delete contents in the website.",
  ...
  },
  {
    title: "Fun-Learn",
    description:
      "FunLearn is a web app that lets you upload any book (PDF, EPUB, text) and instantly transform it into a full learning experience. It generates, Smart summaries capturing key ideas Quizzes to test understanding, Interactive games (flashcards, matching, puzzles), Audio versions so you can listen on the go.",
  ...
  },
  {
    title: "Filer",
    description:
      "Filer-Flame is a clean and user-friendly web application designed for quick and seamless file conversion. It allows users to easily upload files using drag-and-drop or file browsing and convert them into their preferred formats within seconds. The platform focuses on simplicity, speed, and accessibility, making file conversion straightforward without unnecessary steps or distractions.",
  ...
  },
  {
    ...
    description:
      "A fun and interactive birthday-themed website featuring animations and personalized messages.",
  ...
  },
  {
    ...
    description:
      "A simple and intuitive web app to calculate CGPA based on course grades and credit units.",
      ...
      <div className="container relative z-10 px-4 py-8 mx-auto max-w-7xl sm:py-12 md:py-16">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
          ...
          >
            ...
            <span className="text-sm font-pixel sm:text-base">
              Back to Home
            </span>
          </Link>
